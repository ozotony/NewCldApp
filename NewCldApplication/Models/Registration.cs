...
namespace WebApplication4.Models
{
    public class Registration
    {
        ...
        {
            SqlConnection connectionString = new SqlConnection(hf.ConnectXpay());
            SqlCommand command;
            int num;
            ...
            using (connectionString = new SqlConnection(hf.ConnectXpay()))
            {
                using (command = connectionString.CreateCommand())
                {
                    //  command.CommandTimeout = 300;
                    command.CommandText = "INSERT INTO applicant (xname,address,xemail,xmobile ) ";
                    ...
                    command.Parameters.Add("@xname", SqlDbType.NVarChar, 200);
                    command.Parameters.Add("@address", SqlDbType.NVarChar, 500);
                    command.Parameters.Add("@xemail", SqlDbType.VarChar, 100);
                    command.Parameters.Add("@xmobile", SqlDbType.NVarChar, 100);


                    command.Parameters["@xname"].Value = x.applicantname;
                    command.Parameters["@address"].Value = x.address;
                    command.Parameters["@xemail"].Value = x.email;
                    command.Parameters["@xmobile"].Value = x.mobile;
