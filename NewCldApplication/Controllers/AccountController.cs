...
namespace WebApplication4.Controllers
{
  ...
  public IHttpActionResult GetExternalLogin2()
  {
      ...
      return new ChallengeResult2("Facebook", "/api/Account/GetLogged", this.Request);
        ...
        public ApplicationStatus  getApplicationStatus([FromUri] String property1)
        {
            ...
            try
            {
                ...
                List<MarkInfo> lt_mi = ppx.getMarkInfoByUserID(lt_pw[0].ID);
        ...
        public XObjs.InterSwitchPostFields ProceedToPayment2(Shopping_card2 pp4)
        {
            ...
            foreach (Shopping_card _details in pp4.cc)
            {
                ...
                num2 += (Convert.ToInt32(_details.tech_amt) * Convert.ToInt32(_details.qty)) * 100;
              //  amt = amt + (_details.amt * Convert.ToInt32(_details.qty));
               amt = amt + (_details.amt * _details.qty);
            }
            if (amt > 0.0)
            {
                total_amt = Math.Round((double)(amt / 0.985), 2);
            ...
            xispf.product_id = ConfigurationManager.AppSettings["pd_product_id"];
            xispf.currency = ConfigurationManager.AppSettings["pd_currency"];
            xispf.site_redirect_url = "http://5.77.54.44/NewTrademark/ReturnUrl.aspx";
            xispf.site_name = ConfigurationManager.AppSettings["pd_site_name"];
            xispf.pay_item_id = ConfigurationManager.AppSettings["pd_pay_item_id"];
            xispf.mackey = ConfigurationManager.AppSettings["pd_mackey"];
            xispf.local_date_time = DateTime.Now.ToString("dd-MMM-yy HH:MM:ss");
       ...
       List<ViewBasket> ppx =     pp.ViewBasket2(property1, property2);
        ...
        [Route("getBasketDetail2")]
        [AllowAnonymous]
        [HttpGet]
        public List<ViewBasket> getBasketDetail2([FromUri] String property1, [FromUri] String property2)
        {
            var kk = "";

            Retriever pp = new Retriever();
            List<ViewBasket> ppx = pp.ViewBasket3(property1, property2);
            List<ViewBasket> ppx2 = new List<ViewBasket>();
            foreach (ViewBasket x in ppx)
            {
                List<Stage> pp2 = pp.getStageByUserIDAccTm(x.new_transID, property2);
                AppStatus ddx = new AppStatus();

                try { 
                SortedList<string, string> xp = ddx.showTmStatus(pp2[0].status, pp2[0].data_status);
                x.status = xp["status"];
                x.data_status = xp["data_status"];
                }
        ...
        [Route("ResetPassword2")]

        [AllowAnonymous]
        [HttpGet]
        public async Task<IHttpActionResult> ResetPassword2()
        {
            var _db = new ApplicationDbContext();
            _db.Configuration.ProxyCreationEnabled = false;
            ...
            var kd = (from c in _db.Users where c.UserName == "ozotony@yahoo.com"  select c).FirstOrDefault();
            Retriever ret = new Retriever();
            var kdd = ret.getRegistrationEmail("anthony.ozoagu@gmail.com");
            ...
            sendemail("anthony.ozoagu@gmail.com", kdd.Surname);
        ...
        public async Task<IHttpActionResult> ResetPassword([FromUri] String property1)
        {
            ...
            Retriever ret = new Retriever();
            var kdd = ret.getRegistrationEmail(property1);
            string vuserid = kd.Id;
            try
            {
                UserManager.RemovePassword(vuserid);
            ...
            sendemail(property1, kdd.Surname);
            kd.LoginCount = 1;
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            // ccd.LastPasswordChange = DateTime.Now;
            ...
            //  ccd = (from c in _db.Users where c.Id == pp4 select c).FirstOrDefault();
        ...
        //  public GetData3 GetData2([FromUri] String property1)
        {
            ...
            Retriever bb = new Retriever();
            return bb.getPtInfoByPwalletID4(property1, property2);
       ...
       // public IHttpActionResult UpdateCertificate([FromUri] String property1, [FromUri] String property2)
        public MarkInfo UpdateCertificate([FromUri] String property1, [FromUri] String property2)
        {
            var kk = "";

            Retriever ret = new Retriever();
            ret.updateTransID2(property1, property2);

          var dd =  ret.getMarkInfoClassByUserID(property1);
        ...
        [AllowAnonymous]
        [HttpGet]
        public List<GetData> GetChartData()
        {
            Retriever bb = new Retriever();
            List<GetData> aa = new List<GetData>();

            GetData pp = new GetData();

            pp.DataName = "Trademark";
            pp.DataValue = bb.SumTrademark();
            aa.Add(pp);

            GetData pp2 = new GetData();

            pp2.DataName = "Patent";
            pp2.DataValue = bb.SumPatent();
            ...
            pp3.DataName = "Design";
            pp3.DataValue = bb.SumDesign();

            aa.Add(pp3);

            GetData pp4 = new GetData();

            pp4.DataName = "Accreditation";
            pp4.DataValue = bb.SumAccreditation();
        ...
        [AllowAnonymous]
        [HttpGet]
        public List<GetData> GetChartDataB([FromUri] String property1, [FromUri] String property2)
        {
            Retriever bb = new Retriever();
            List<GetData> aa = new List<GetData>();
            ...
            pp.DataName = "Trademark";
            pp.DataValue = bb.SumTrademark2(property1, property2);
            aa.Add(pp);

            GetData pp2 = new GetData();

            pp2.DataName = "Patent";
            pp2.DataValue = bb.SumPatent2(property1, property2);
            ...
            pp3.DataName = "Design";
            pp3.DataValue = bb.SumDesign2(property1, property2);
            ...
            pp4.DataName = "Accreditation";
            pp4.DataValue = bb.SumAccreditation2(property1, property2);
        ...
        [AllowAnonymous]
        [HttpGet]
        public List<GetData2> GetChartData2()
        {
            Retriever bb = new Retriever();
            return bb.getAgentData();
        ...
        [Route("GetChartData2B")]
        [AllowAnonymous]
        [HttpGet]
        public List<GetData2> GetChartData2B([FromUri] String property1, [FromUri] String property2)
        {
            Retriever bb = new Retriever();
            return bb.getAgentDataB(property1, property2);
        ...
        [AllowAnonymous]
        [HttpGet]
        public List<GetData2> GetChartData3()
        {
            Retriever bb = new Retriever();
            return bb.getAgentData3();
        ...
        [Route("GetChartData3B")]
        [AllowAnonymous]
        [HttpGet]
        public List<GetData2> GetChartData3B([FromUri] String property1, [FromUri] String property2)
        {
            Retriever bb = new Retriever();
            return bb.getAgentData3B(property1, property2);
        ...
        [AllowAnonymous]
        [HttpGet]
        public List<GetData2> GetChartData4()
        {
            Retriever bb = new Retriever();
            return bb.getAgentData4();
        ...
        [Route("GetChartData4B")]
        [AllowAnonymous]
        [HttpGet]
        public List<GetData2> GetChartData4B([FromUri] String property1, [FromUri] String property2)
        {
            Retriever bb = new Retriever();
            return bb.getAgentData4B(property1, property2);
        ...
        [Route("ApplicationOfficer")]
        [AllowAnonymous]
        [HttpGet]
        public List<ApplicationOfficer2> ApplicationOfficer([FromUri] String property1, [FromUri] String property2)
        {
            Retriever bb = new Retriever();
            return bb.ApplicationOff(property1, property2);
        ...
        [AllowAnonymous]
        [HttpGet]
        public MarkInfo GetMarkById([FromUri] String property1)
        {
            Retriever bb = new Retriever();
            return bb.getMarkInfoClassByUserID(property1);
        ...
        [Route("ApplicationOfficer2")]
        [AllowAnonymous]
        [HttpGet]
        public List<ApplicationOfficer3> ApplicationOfficer2([FromUri] String property1, [FromUri] String property2)
        {
            Retriever bb = new Retriever();
            return bb.ApplicationOff2(property1, property2);
        ...
        [AllowAnonymous]
        [HttpGet]
        public IHttpActionResult UploadUser2([FromUri] String property1)
        {
            var ccd = (from c in db4.registrations where c.Email == property1  select c.Email ).Distinct().ToList();
        ...
        public void UploadUser3(string ss)
        {
            var ccd = (from c in db4.registrations where c.Email == ss select c.Email).Distinct().ToList();
        ...
        public Interswitch2 formx2(Shopping_card2 pp4)
        {
            ...
            pp.pd_payment_page = ConfigurationManager.AppSettings["pd_payment_page"];
            pp.product_id = ConfigurationManager.AppSettings["pd_product_id"];
            pp.site_redirect_url = "http://5.77.54.44/NewTrademark/ReturnUrl.aspx";
        ...
        [AllowAnonymous]
        [HttpGet]
        public XObjs.Registration GetRegistrationById([FromUri] String property1)
        {

            Retriever ret = new Retriever();
            var pp  = ret.getRegistrationByID(property1);
            UploadUser3(pp.Email);
            return  pp;
        ...
        public Shopping_card2 ReturnUrl2([FromUri] String property1)
        {
          ...
          //  Shopping_card2 pp3 = (Shopping_card2)session["Shopping_card2"];
            ...
            var mackey = ConfigurationManager.AppSettings["pd_mackey"];
            var check_trans_page = ConfigurationManager.AppSettings["pd_get_trans_json_page"];
            var siteredirect = "http://5.77.54.44/NewTrademark/ReturnUrl.aspx";
        ...
        public List<XObjs.Office_view>  SearchDb2(SearchDb pp)

       
        {

            List<string> fulltext = new List<string>();
            string str = pp.Productitle.Replace("'", "");
            ...
            List<XObjs.Office_view> lt_m = ret.getNewAdminSearchMarkInfoRS222("2", "Valid", "product_title", fulltext, "", "");
        ...
        [Route("GetResult")]
        [HttpGet]
        public List<XObjs.Office_view> GetResult()
        {

            List<string> fulltext = new List<string>();
            string pp2 = "car";
            string str = pp2.Replace("'", "");
            foreach (string str2 in str.Split(new char[] { ' ' }))
            {
                if (str2 != "")
                {
            ...
            Retriever ret = new Retriever();
            List<XObjs.Office_view> lt_m = ret.getNewAdminSearchMarkInfoRS333("2", "Valid", "product_title", fulltext, "", "", 1, 50);
        ...
        [HttpGet]
        public List<XObjs.Registration> AgentRegistration()
        {

            Retriever mm = new Retriever();
            return mm.getAllRegistrations();
        ...
        public List<XObjs.Office_view> SearchDb3(SearchDb pp)
...

        {
            ...
            List<XObjs.Office_view> lt_m = ret.getNewAdminSearchMarkInfoRS333("2", "Valid", "product_title", fulltext, "", "",pp.vcount,20);
    ...
    new MailAddress(vemail));
          ...
          //  Models.Email dd1 = new Models.Email();
          //  dd1.sendMail("Pasword Reset", vemail, "paymentsupport@einaosolutions.com", "Pasword Reset", ss, "");
